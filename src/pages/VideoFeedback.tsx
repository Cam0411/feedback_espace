...
export default function VideoFeedback({ sharedVideoId }: { sharedVideoId?: string }) {
  ...
  const { user: currentUser, isSidebarCollapsed, setIsSidebarCollapsed } = useOutletContext<{ 
    user: User | null; 
  ...
  return (
    <div className="flex flex-col h-full bg-[#0e1015] overflow-hidden text-slate-300 relative">
      ...
      <div className="flex-1 flex flex-col lg:flex-row overflow-hidden relative">
        ...
        {/* Center Column - Video */}
        <div className="w-full lg:flex-1 flex flex-col relative bg-[#07080c] goku-background-charge h-full overflow-y-auto lg:overflow-hidden shrink-0 custom-scrollbar">
