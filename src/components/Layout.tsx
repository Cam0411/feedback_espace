        ...
        <div className={cn(
          ...
          <Link to="/" className={cn(
            ...
            <div className="flex flex-col">
              <span className="font-black text-base sm:text-lg tracking-tight leading-none text-white uppercase italic goku-ki-text">Espace</span>
            ...
            {(!isVideoPage || !isSidebarCollapsed) && (
              <div className="flex-1 overflow-hidden animate-in fade-in duration-300">
                <div className="flex items-center gap-2">
                  ...
                  {user?.role === 'admin' && (
                    <span className="bg-gradient-to-r from-amber-500 to-orange-600 text-white text-[8px] font-black px-2 py-0.5 rounded-md tracking-widest uppercase shadow-[0_0_8px_rgba(242,92,5,0.4)] animate-pulse">SAIYAN ADMIN</span>
                  )}
                </div>
                <div className="text-[10px] font-extrabold text-amber-400 truncate flex items-center gap-1 uppercase tracking-wider">
